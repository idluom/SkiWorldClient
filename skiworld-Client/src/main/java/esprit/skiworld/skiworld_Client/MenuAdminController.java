...
public class MenuAdminController implements Initializable {
	...
	@FXML
	public void tracks(ActionEvent event) {
		try {
			rootPane = (AnchorPane) FXMLLoader.load(getClass().getResource("/fxml/Track.fxml"));
			PaneDrawer.setContent(rootPane);
			PaneDrawer.setDefaultDrawerSize(0);
			PaneDrawer.toFront();
			hamburger.toFront();
	...
	@FXML
	public void training(ActionEvent event) {
		try {
			rootPane = (AnchorPane) FXMLLoader.load(getClass().getResource("/fxml/Training.fxml"));
			PaneDrawer.setContent(rootPane);
			PaneDrawer.setDefaultDrawerSize(0);
			PaneDrawer.toFront();
			hamburger.toFront();
	...
	public void transport(ActionEvent event) {
		try {
			rootPane = (AnchorPane) FXMLLoader.load(getClass().getResource("/fxml/Transport.fxml"));
			PaneDrawer.setContent(rootPane);
			PaneDrawer.setDefaultDrawerSize(0);
			PaneDrawer.toFront();
			hamburger.toFront();
