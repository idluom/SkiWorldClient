...
public class MenuShopController implements Initializable {
	@FXML
	...
	public void bills(ActionEvent event) {
		try {
			rootPane = (AnchorPane) FXMLLoader.load(getClass().getResource("/fxml/Bill.fxml"));
			PaneDrawer.setContent(rootPane);
			PaneDrawer.setDefaultDrawerSize(0);
			PaneDrawer.toFront();
			hamburger.toFront();
	...
	public void addDiscount(ActionEvent event) {
		try {
			rootPane = (AnchorPane) FXMLLoader.load(getClass().getResource("/fxml/AddDiscount.fxml"));
			PaneDrawer.setContent(rootPane);
			PaneDrawer.setDefaultDrawerSize(0);
			PaneDrawer.toFront();
			hamburger.toFront();
	...
	@FXML
	public void affectDiscount(ActionEvent event) {
		try {
			rootPane = (AnchorPane) FXMLLoader.load(getClass().getResource("/fxml/AffectDiscount.fxml"));
			PaneDrawer.setContent(rootPane);
			PaneDrawer.setDefaultDrawerSize(0);
			PaneDrawer.toFront();
			hamburger.toFront();
